    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItems_User_PersonId",
                        column: x => x.PersonId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Whitelists_User_PersonId",
                        column: x => x.PersonId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "06f6db20-637a-47f2-9e3b-6a6e236bd514", null, "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "6950d86e-37a5-4be6-a8bd-8421bc1fa487", 0, "4f147c3f-2d15-4766-8443-6bca0c073fd3", "amoshhamal7@gmail.com", true, false, null, "ADMIN@YOURAPP.COM", "AMOSHHAMAL7@gmail.com", "AQAAAAIAAYagAAAAEDSyRmlQ8h+F1D6SiX711dYwtCB9KemNy1bWmX3H0gjAazCLRKPAf5mCtyyvHCRdSA==", null, false, "b16ba5b4-6f7d-4487-a5ad-7c72603b3285", false, "amoshhamal7@gmail.com" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "06f6db20-637a-47f2-9e3b-6a6e236bd514", "6950d86e-37a5-4be6-a8bd-8421bc1fa487" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseHistories_PersonId",
                table: "PurchaseHistories",
                column: "PersonId");
